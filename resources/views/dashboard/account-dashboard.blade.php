                                 ...
                                 <div class="col-lg-3 col-6">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <p class="text-muted text-sm mt-4 mb-2">{{__('Role')}}</p>
                                            <h6 class="mb-3">{{__('User Type')}}</h6>
                                            <h3 class="mb-0">{{\Auth::user()->type}}
                                            </h3>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-6">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <p class="text-muted text-sm mt-4 mb-2">{{__('Total')}}</p>
                                            <h6 class="mb-3">{{__('Quotations')}}</h6>
                                            <h3 class="mb-0">{{$quotes}}
                                            </h3>
                                        </div>
                                    </div>
                                </div
