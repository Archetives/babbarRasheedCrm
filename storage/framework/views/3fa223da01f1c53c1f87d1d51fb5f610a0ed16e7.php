                                    ...
                                    <?php if( Gate::check('edit job') ||Gate::check('delete job') || Gate::check('show job')): ?>
                                        ...
                                        <?php if($job->status!='in_active'): ?>
                                            <div class="action-btn bg-warning ms-2">
                                                <a href="<?php echo e(route('job.requirement',[$job->code,!empty($job)?$job->createdBy->lang:'en'])); ?>" class="mx-3 btn btn-sm align-items-center copy_link bs-pass-para" data-bs-toggle="tooltip" data-original-title="<?php echo e(__('Click to copy')); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/babarras/public_html/crm/resources/views/job/index.blade.php ENDPATH**/ ?>