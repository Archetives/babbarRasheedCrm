    ...
    <div class="row">
        <div class="col-lg-4 col-md-4 col-sm-6">
            <div class="form-group">
                ...
                <div class="form-icon-user">
                 ...
                 <?php echo e(Form::label('lead',__('Lead_id'),array('class'=>'form-label'))); ?>

                <div class="form-icon-user">
                    <?php echo e(Form::text('lead',null,array('class'=>'form-control','required'=>'required'))); ?>
        ...
        <div class="col-lg-4 col-md-4 col-sm-6">
            <div class="form-group">
                ...
                <div class="form-icon-user">
                    <?php echo e(Form::password('password',array('class'=>'form-control','minlength'=>"6"))); ?>
...
<?php /**PATH /home2/babarras/public_html/resources/views/customer/create.blade.php ENDPATH**/ ?>