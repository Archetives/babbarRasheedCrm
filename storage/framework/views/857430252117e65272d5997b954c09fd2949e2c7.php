                                        ...
                                        <div class="card-body">
                                            <div class="d-flex align-items-center justify-content-between">
                                                ...
                                                <div class="user-group">
                                                    ...
                                                    <img <?php if($application->profile): ?> src="<?php echo e(asset('/storage/uploads/job/profile/'.$application->profile)); ?>" <?php else: ?> src="<?php echo e(asset('/storage/uploads/avatar/avatar.png')); ?>" <?php endif; ?> class="hweb">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/babarras/public_html/crm/resources/views/jobApplication/index.blade.php ENDPATH**/ ?>