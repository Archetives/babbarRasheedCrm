                    ...
                    <div class="card-body employee-detail-edit-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select class=" form-control " id="designation_id" name="designation_id"  data-placeholder="<?php echo e(__('Select Designation ...')); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/babarras/public_html/crm/resources/views/employee/edit.blade.php ENDPATH**/ ?>