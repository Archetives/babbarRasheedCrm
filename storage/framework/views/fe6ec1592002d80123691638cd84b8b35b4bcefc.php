...
<div class="modal-body">
    <div class="row">
        ...
        <div class="col-6 form-group">
            ...
            <?php echo e(Form::select('pipeline_id', $pipelines,null, array('class' => 'form-control select2','id'=>'choices-multiple1','required'=>'required'))); ?>

        </div>
        <div class="col-6 form-group">
            <?php echo e(Form::label('stage_id', __('Stage'),['class'=>'form-label'])); ?>

            <?php echo e(Form::select('stage_id', [''=>__('Select Stage')],null, array('class' => 'form-control ','id'=>'choices-multiple2','required'=>'required'))); ?>
...
<?php /**PATH /home2/babarras/public_html/crm/resources/views/deals/edit.blade.php ENDPATH**/ ?>