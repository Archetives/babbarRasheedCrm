        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create constant category')): ?>
            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6">
                <a href="<?php echo e(route('zoom-meeting.calender')); ?>"  data-original-title="<?php echo e(__('Calender View')); ?>" class="btn btn-xs btn-white btn-icon-only width-auto">
                    <i class="ti ti-calendar"></i> <?php echo e(__('Calender View')); ?>
...
<?php $__env->startSection('action-btn'); ?>
    <div class="float-end">
        ...
        <a href="<?php echo e(route('zoom-meeting.calender')); ?>"  data-original-title="<?php echo e(__('Calender View')); ?>" class="btn btn-sm btn-primary">
            <i class="ti ti-calendar"></i> <?php echo e(__('Calender View')); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/babarras/public_html/crm/resources/views/zoom-meeting/index.blade.php ENDPATH**/ ?>