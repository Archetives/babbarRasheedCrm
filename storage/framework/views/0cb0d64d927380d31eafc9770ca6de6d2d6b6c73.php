                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center ">
                            <div class="col col-lg-3 col-md-6 col-sm-12 col-12 ">
                                <div class="btn-box">
                                    <?php echo e(Form::text('date', isset($_GET['date'])?$_GET['date']:null, array('class' => 'month-btn form-control pc-datepicker-1'))); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/babarras/public_html/resources/views/revenue/index.blade.php ENDPATH**/ ?>