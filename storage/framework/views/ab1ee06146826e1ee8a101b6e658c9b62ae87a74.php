...
<div class="modal-body">
 ...
 <select class="select form-control select-multiple" id="employee" name="employee" data-toggle="select2" data-placeholder="<?php echo e(__('Select Employee')); ?>" required>
                </select>
        ...
        <div class="col-md-6">
            <div class="form-group">
                <?php echo e(Form::label('appraisal_date',__('Select Month'),['class'=>'form-label'])); ?>

                <?php echo e(Form::date('appraisal_date','', array('class' => 'form-control'))); ?>
...
<div class="modal-footer">
 ...
 <?php /**PATH /home2/babarras/public_html/crm/resources/views/appraisal/create.blade.php ENDPATH**/ ?>