                                ...
                                <div class="col-lg-3 col-6">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <h6 class="mb-3"><?php echo e(__('Leads')); ?></h6>
                                            <h3 class="mb-0"><?php echo e($leads); ?>
                                 ...
                                 <div class="col-lg-3 col-6">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <p class="text-muted text-sm mt-4 mb-2"><?php echo e(__('Role')); ?></p>
                                            <h6 class="mb-3"><?php echo e(__('User Type')); ?></h6>
                                            <h3 class="mb-0"><?php echo e(\Auth::user()->type); ?>
                                ...
                                <div class="col-lg-3 col-6">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <p class="text-muted text-sm mt-4 mb-2"><?php echo e(__('Total')); ?></p>
                                            <h6 class="mb-3"><?php echo e(__('Quotations')); ?></h6>
                                            <h3 class="mb-0"><?php echo e($quotes); ?>
                                 ...
                                 <div class="col-lg-3 col-6">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <p class="text-muted text-sm mt-4 mb-2"><?php echo e(__('Total')); ?></p>
                                            <h6 class="mb-3"><?php echo e(__('Owners')); ?></h6>
                                            <h3 class="mb-0"><?php echo e($owner); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/babarras/public_html/resources/views/dashboard/account-dashboard.blade.php ENDPATH**/ ?>