...
<?php $__env->startSection('action-btn'); ?>
    <div class="float-end">
        ...
        <?php else: ?>
            <a href="<?php echo e(route('bugs.view', 'grid')); ?>" class="btn btn-primary btn-sm">
                                                    ...
                                                    <p class="mb-0">
                                                        ...
                                                        <a href="#" class="btn btn-sm mr-1 p-0 rounded-circle grid_user_image">
                                                            <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <img src="<?php echo e((!empty($user->avatar))? asset(Storage::url("uploads/avatar/".$user->avatar)): asset(Storage::url("uploads/avatar/avatar.png"))); ?>" alt="kal" class="rounded-circle" width="25" height="25">
                                                                <img src="<?php echo e((!empty($user->avatar))? asset(Storage::url("uploads/avatar/".$user->avatar)): asset(Storage::url("uploads/avatar/avatar.png"))); ?>" alt="kal" class="rounded-circle" width="25" height="25">
                                                                <img src="<?php echo e((!empty($user->avatar))? asset(Storage::url("uploads/avatar/".$user->avatar)): asset(Storage::url("uploads/avatar/avatar.png"))); ?>" alt="kal" class="rounded-circle" width="25" height="25">
                                                                <img src="<?php echo e((!empty($user->avatar))? asset(Storage::url("uploads/avatar/".$user->avatar)): asset(Storage::url("uploads/avatar/avatar.png"))); ?>" alt="kal" class="rounded-circle" width="25" height="25">
                                                                <img src="<?php echo e((!empty($user->avatar))? asset(Storage::url("uploads/avatar/".$user->avatar)): asset(Storage::url("uploads/avatar/avatar.png"))); ?>" alt="kal" class="rounded-circle" width="25" height="25">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/babarras/public_html/resources/views/projects/allBugGridView.blade.php ENDPATH**/ ?>